...
bot_name = "Canteen buddy"  # Statically asssigning the name of chat bot
...
responses = {
    ...
    [
        "The fees of canteen is approximetely 60000 per year which is added in the hostel fees.\nWhile on daily basic it is dependent on the menu and is at max 100 - 120 rupees per plate. "
    ],
    "is canteen open on sunday ?":
    [
        "Yes, It is open in morning but not closed in evening."
    ],
    "is breakfast included hostel fees ?":
    [
        "No, It is not included it just contains the lunch and dinner.\n But, If you want the breakfast you can pay and have it.."
    ],
    "": 
    [ 
        "Hey! Are you there?", 
